      ...
      <div className="container mx-auto grid gap-5 md:grid-cols-3 my-10">
        <div class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
          ...
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
            <span className="text-xl ">Authorization</span> in system security
            is the process of giving the user permission to access a specific
            ...
            various ways to be authenticated. Read more: Difference between
            Authentication and Authorization | Difference Between
          </p>
        </div>
        <div class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
          <p>
          ...
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
            ...
            Google.Accelerate app development with fully managed backend.
            Firebase provide Products and Solutions. Accelerate Development.
            Monitor App. Firebase also provide completely free services, like
            Authentication, and Cloud or In-App Messagin Performance.
            infrastructure.These services, although often missed, boost
            Firebase's already tremendous value by a fair bit
        ...
        <div class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
          ...
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
            Firebase helps us develop high-quality apps, grow your user base.
